...
public class Server implements ActionListener {
	...
	public Server(){
		...
		// DP Image;
		ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("VideoChattingApp/Icons/AMAR_DP.jpg"));
		...
		// Name Label;
		JLabel l3 = new JLabel("AMAR");
		l3.setBounds(100, 0, 100, 30);
	...
	public static void main(String[] args) {
		...
		// Printing input and output in text area;
		String msgInput="";

        try{
            serSkt = new ServerSocket(6001);
            while(true){
                skt = serSkt.accept();
